...
public class MainActivity extends AppCompatActivity
    ...
    //Inisiasi kembalian dari accelerometer dan magnetometer dengan 3 data
    //masing-masing
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        switch (sensorType){
            case Sensor.TYPE_ACCELEROMETER:
                //di copy keseluruhan data karena float ke dalam variabel
        ...
        //kedua Data yang diperoleh di taruh di variabel baru
        float[] rotationMatrix=new float[9];
        //diambil datanya sekaligus check apakah ada rotasi atau tidak
        boolean rotationOK=SensorManager.getRotationMatrix(rotationMatrix,null,
                mAccelerometerData,mMagnetometerData);
        //check if any orientation with rotation matrix
        ...
        //Check nilai absolut dari pitch dan roll apakah kurang dari
        //value drift (0.05) maka akan dianggap 0
